...
// material-ui
import { FormControl, MenuItem, OutlinedInput, Select, Slider, Stack, TextField, Tooltip, Checkbox, FormControlLabel } from '@mui/material';
    ...
    <Stack direction="row" spacing={1}>
      ...
      {advancedSearch && (
        <>
          ...
          <FormControlLabel
            control={
              <Checkbox checked={advancedSearch.pending} onChange={handleSearchFilter} name="pending" color="primary" size="small" />
            }
            label="Pending"
          />
          <FormControlLabel
